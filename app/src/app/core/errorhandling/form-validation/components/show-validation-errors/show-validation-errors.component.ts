...
export class ShowValidationErrorsComponent {
 ...
 @Input() public control: AbstractControlDirective | AbstractControl; //code change : changed to public : Property 'control' is private and only accessible within class 'ShowValidationErrorsComponent'
 @Input() public shouldShow: boolean = true;//code change : changed to public : Property 'shouldShow' is private and only accessible within class 'ShowValidationErrorsComponent'
