...
export class CustomValidators {
  ...
  static requiredField(customMessage: string = ''): ValidatorFn {
    return (c: AbstractControl): ValidationError | null => { //code changed : changed FormControl to AbstractControl
  ...
  static requiredPositiveNumber(c: FormControl): ValidatorFn { //code changed : changed FormControl to AbstractControl
