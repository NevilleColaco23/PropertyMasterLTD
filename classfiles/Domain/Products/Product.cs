...
public class Product : MyEntity
{
    ...
    [Required]
    public string MassUnitSymbol { get; private set; }

    [Required]
    public double MassValue { get; private set; }
    ...
    private Product()
    {
        ...
        Mass = null!;
        Price = null!;
        MassUnitSymbol = ProductInvariants.DefaultMassUnit.Symbol; // Initialize with a default value
        MassValue = 0;
        PriceAmount = 0;
        PriceCurrencyCode = ProductInvariants.DefaultPriceCurrency.Code; // Initialize with a default value
    }
