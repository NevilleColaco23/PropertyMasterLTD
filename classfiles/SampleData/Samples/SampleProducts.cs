...
namespace MyWarehouse.SampleData.Samples;
...
internal static class SampleProducts
{
    ...
    internal static List<Product> GenerateSampleProducts(int number)
    {
        ...
        return uniqueNames.Select(name => new Product(
            ...
            new Money(0, Currency.AUD),
            new Mass(0, MassUnit.Gram)
        //priceAmount: new Money(_rnd.Next(10, 999) + 0.99M, Currency.Default),
        //massValue: new Mass(_rnd.Next(10, 200) * 0.1f, MassUnit.Kilogram),
        //MassUnitSymbol: "",
        //NumberInStock: 1,
        //PriceCurrencyCode: Currency.USD.ToString()
        )).ToList();
